        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/dashboard/guest" className="text-gray-600 hover:text-edu-blue transition-colors">
                  Try as Guest
                </Link>
              </li>
              <li>
                <Link to="/leaderboard" className="text-gray-600 hover:text-edu-blue transition-colors">
                  Leaderboard
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/courses" className="text-gray-600 hover:text-edu-blue transition-colors">
                  Courses
                </Link>
              </li>
              <li>
                <Link to="/ai-tutor" className="text-gray-600 hover:text-edu-blue transition-colors">
                  AI Tutor
                </Link>
              </li>
              <li>
                <Link to="/assessments" className="text-gray-600 hover:text-edu-blue transition-colors">
                  Assessments
                </Link>
              </li>
              <li>
                <a href="#" className="text-gray-600 hover:text-edu-blue transition-colors">
                  Blog
                </a>
              </li>
              <li>
